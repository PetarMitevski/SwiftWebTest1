...
final class PostController1: ResourceRepresentable {
    ...
    func sss(_ request: Request) throws -> ResponseRepresentable {
...
//        return post
    ...
    /// implementation
    internal func makeResource() -> Resource<Post> {
        return Resource(
            index: index,
            store: sss,
            show: show,
...
extension PostController1: EmptyInitializable { }
